...
| Tags       | `#d4a373` | Sand (transparent background) |

### Light Theme

| Element    | Color     | Description                     |
| ---------- | --------- | ------------------------------- |
| Background | `#f0e4d4` | Warm latte                      |
| Text       | `#3a2e22` | Warm dark brown                 |
| Accent     | `#a07a5a` | Cinnamon                        |
| Highlights | `#b88a5c` | Copper                          |
| Tags       | `#b88a5c` | Copper (transparent background) |
...
Have an idea for a new feature or a cozy detail you'd love to see in Copper Rose? I'd love to hear it!
